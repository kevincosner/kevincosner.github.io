var ImageBox = function(parent, config) {
    ...
    inputText.innerHTML = "<font size=+1><b><i>Input RGB-D image pair of the " + sceneName + " scene <br></i></b></font>";
    this.containerDiv.appendChild(inputText);
    this.inputColor = document.createElement("img"); 
    this.inputColor.src = config.inputColor;
    this.inputColor.className = "input-display";
    this.inputColor.width = 390;
    this.containerDiv.appendChild(this.inputColor);
    
    var space = document.createElement("font");
    space.innerHTML = "&nbsp";
    this.containerDiv.appendChild(space);
    
    this.inputDepth = document.createElement("img"); 
    this.inputDepth.src = config.inputDepth;
    this.inputDepth.className = "input-display";
    this.inputDepth.width = 390;
    this.containerDiv.appendChild(this.inputDepth);

    var spaceBar = document.createElement("div");
    spaceBar.innerHTML = "<br>";
    this.containerDiv.appendChild(spaceBar);

    var resultText = document.createElement("div");
    resultText.innerHTML = "<font size=+1><b>Results (please move the mouse over the image to zoom in and compare details)</b></font>";
    this.containerDiv.appendChild(resultText);
